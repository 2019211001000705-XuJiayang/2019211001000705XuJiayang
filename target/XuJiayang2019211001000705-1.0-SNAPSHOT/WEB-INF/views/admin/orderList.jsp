		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>order Date</td>
					<%
						com.XuJiayang.model.Order o=(com.XuJiayang.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.XuJiayang.dao.UserDao userDao=new com.XuJiayang.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.XuJiayang.model.Payment.findByPaymentId(con,n);
						%>
